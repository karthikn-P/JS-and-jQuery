		...
		if($ul.is("ul") && $ul.children("li").length && $ul.find(".bzoom_big_image").length){
			...
			if(!$(".bzoom_small_thumbs").length){
				...
				for(var i=0; i<_option.small_thumbs; i++){
					...
					if(i==0){
						html += '<li class="bzoom_smallthumb_active"><img src="'+smurl+'"  style="width:'+smwidth+'px; height:'+smheight+'px;" /></li>';
					}else{
						html += '<li style="opacity:0.4;"><img src="'+smurl+'"  style="width:'+smwidth+'px; height:'+smheight+'px;" /></li>';
					}
				}
